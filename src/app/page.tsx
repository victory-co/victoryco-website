    ...
    <main className="relative overflow-hidden">
      ...
      <section className="relative flex min-h-[100dvh] flex-col items-center justify-center px-4 pt-16">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          {/* Crown icon with gold ring */}
          <div className="relative mb-8">
            <div className="absolute -inset-4 rounded-full border border-[#d4a843]/10" />
            <div className="absolute -inset-8 rounded-full border border-[#d4a843]/5" />
            <CrownIcon className="h-20 w-20 text-[#d4a843] sm:h-24 sm:w-24" />
          </div>
      ...
      <section className="relative px-4 py-24 sm:py-32">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          <ScrollReveal>
            <CrownIcon className="mx-auto mb-6 h-12 w-12 text-[#d4a843]/60" />
